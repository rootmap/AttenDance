...
class SystemModuleController extends Controller
{
    ...
    {
        $company=Company::all();
        return view('module.settings.module',['company'=>$company]);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->action('SystemModuleController@index')->with('success','Information Added Successfully');
...
$payments = Payment::join('users', 'users.id', '=', 'payments.id')
    ...
    */
        ...
        // Define the Excel spreadsheet headers
            $excelArray[] = \DB::getSchemaBuilder()->getColumnListing("system_modules");
        ...
        // Generate and return the spreadsheet
            \Excel::create('SystemModuleData_'.date('d_m_Y_H_i_s'), function($excel) use ($excelArray) {

            // Set the spreadsheet title, creator, and description
                $excel->setTitle('SystemModule');
        ...
        public function exportPdf()
        {
            ...
            $content='<h3>System Module List</h3>';
    ...
    public function edit($id)
    {
        ...
        return view('module.settings.module',['data'=>$data,'company'=>$company]);
    }
    ...
    public function update(Request $request,$id)
    {
        ...
        return redirect()->action('SystemModuleController@index')->with('success','Information Updated Successfully');
    }
    ...
    {
        $del=SystemModule::destroy($request->id);
        return 1;    
    }
}
