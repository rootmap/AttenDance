<?php
if (isset($data)) {
    $pageinfo = array("Edit Branch Settings", "Edit Branch Record", "", "SUL");
} else {
    $pageinfo = array("Branch Settings", "Add Branch Record", "", "SUL");
}
?>
                ...
                <div class="card-block">
                    <div class="row">
                        <div class="col-xl-4">
                            ...
                            @if(isset($data))
                            <form name="Branch" action="{{url('Settings/Branch/Update/'.$data['id'])}}" method="post">
                                {{csrf_field()}}
                                <div class="row">
                                    <div class="col-lg-12">
                            ...
                            @else
                            <form name="Branch" action="{{url('Settings/Branch/Add')}}" method="post">
                                {{csrf_field()}}
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                            value="{{ old('name') }}"
                                            name="name" class="form-control" placeholder="Type Branch Name" id="l30">
                                        </div>
                                    </div>
                                    @if(empty($logged_emp_com) || !isset($logged_emp_com) || $logged_emp_com=="Undefined")
                                    <div class="col-lg-12">
                        ...
                        <div class="col-xl-8">
                            ...
                            <script id="action_template" type="text/x-kendo-template">
                                <a class="k-button k-button-icontext k-grid-edit" href="{{url('Settings/Branch/Edit')}}/#=id#"><span class="k-icon k-edit"></span> Edit</a>
