<?php
$pageinfo = array("Missing Punch Report", "Missing Punch Report", "", "SUL", "Filter Missing Punch Report", "Genarate Missing Report");
?>
                                ...
                                function KendoManualInitialized(link, data)
                                {
                                    var dataSource = new kendo.data.DataSource({
                                        transport: {
                                            ...
                                            update: {
                                                url: "<?= url('/Report/MissingPunch/Update') ?>",
                                                type: "POST",
                                                datatype: "json",
                                                data: {
                                                    '_token': "<?= csrf_token() ?>",
...
//                                                template: "#= kendo.toString(date,'yyyy-mm-dd') #",
											...
											{
                                                field: "admin_out_time",
                                                title: "Out Time",
                                                width: "50px",
                                                format: "{0:HH:mm:ss}"
                                            },
											{
                                                field: "admin_day_status",
                                                title: "Status",
                                                width: "50px"
                                            },
                                            {
                                ...
                                $(document).ready(function () {
                                    ...
                                    $("button[name='filter']").click(function () {
                                        ...
                                        var param = {'company_id': company_id,
                                            ...
                                            'end_date': e_date,
                                            '_token': '<?= csrf_token() ?>'};
                                        var link = "Report/MissingPunch/filter";
                                    ...
                                    $("#export_excel").click(function () {
                                        ...
                                        var link = "<?= url('/') ?>/Report/MissingPunch/Export/Excel/" + company_id + "/" + start_date + "/" + end_date;
                                    ...
                                    $("#export_pdf").click(function () {
                                        ...
                                        var param = {'company_id': company_id, 'start_date': start_date, 'end_date': end_date, '_token': '<?= csrf_token() ?>'};
                                        var link = "<?= url('/') ?>/Report/MissingPunch/Export/Pdf/" + company_id + "/" + start_date + "/" + end_date;
                                        window.location.href = link;
                                    });
