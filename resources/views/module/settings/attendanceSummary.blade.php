<?php
$pageinfo = array("Attendance Report Summary", "Attendance Report Summary", "", "SUL", "Filter Attendance Report Summary", "Genarate Report");
?>
                                ...
                                <div class="col-lg-3">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="company_id">
                                            ...
                                            <option <?php if ($logged_emp_com == $row->id) { ?> selected="selected" <?php } ?> value="{{$row->id}}">{{$row->name}}</option>
                                            @endforeach
                                            @endif
...
//                                }
                                ...
                                $(document).ready(function () {
                                    ...
                                    $("button[name='filter']").click(function () {
                                        ...
                                        var company = 0;
                                        if ($("select[name='company_id']").length == 0) {
									...
									else
									{
                                        ...
                                        $.post("<?= url('AttendanceSummary/Report') ?>", {'company': company, 'department': department_id, 'start_date': s_date, 'end_date': e_date, '_token': '<?= csrf_token() ?>'}, function (data) {
...
//                                               
                                    ...
                                    $("#export_excel").click(function () {
										...
										var department = 0;
                                        if ($("select[name='department_id']").length ==0) {
											department = 0;
                                        }
										else
										{
											department=$("select[name='department_id']").val();
										}
                                        ...
                                        var link = "<?= url('AttendanceSummary/Export/Excel') ?>/" + company + "/" + department + "/" + start_date + "/" + end_date;
                                    ...
                                    $("#export_pdf").click(function () {
                                        ...
                                        var start_date = $("input[name='start_date']").val();
                                        var end_date = $("input[name='end_date']").val();
                                        var link = "<?= url('/') ?>/AttendanceSummary/Export/Pdf/" + company + "/" + department + "/" + start_date + "/" + end_date;
                                        window.location.href = link;
