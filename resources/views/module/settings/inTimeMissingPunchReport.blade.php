<?php
$pageinfo = array("In Time Missing Punch Report", "In Time Missing Punch Report", "", "SUL", "Filter In Time Missing Punch Report", "Genarate Report");
?>
                                ...
                                function KendoManualInitialized(link, data)
                                {
                                    var dataSource = new kendo.data.DataSource({
                                        transport: {
                                            ...
                                            update: {
                                                url: "<?= url('/Report/InTimeMissingPunch/Update') ?>",
                                                type: "POST",
                                                datatype: "json",
                                                data: {
                                                    '_token': "<?= csrf_token() ?>",
                                ...
                                $(document).ready(function () {
                                    ...
                                    $("button[name='filter']").click(function () {
                                        ...
                                        var param = {'company_id': company_id,
                                            ...
                                            'end_date': e_date,
                                            '_token': '<?= csrf_token() ?>'};
                                        var link = "Report/InTimeMissingPunch/filter";
                                    ...
                                    $("#export_excel").click(function () {
                                        ...
                                        var link = "<?= url('/') ?>/Report/InTimeMissingPunch/Export/Excel/" + company_id + "/" + start_date + "/" + end_date;
                                    ...
                                    $("#export_pdf").click(function () {
                                        ...
                                        var param = {'company_id': company_id, 'start_date': start_date, 'end_date': end_date, '_token': '<?= csrf_token() ?>'};
                                        var link = "<?= url('/') ?>/Report/InTimeMissingPunch/Export/Pdf/" + company_id + "/" + start_date + "/" + end_date;
                                        window.location.href = link;
                                    });
