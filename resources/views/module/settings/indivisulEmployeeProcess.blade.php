...
if (isset($data)) {
    ...
    $pageinfo = array("Indivisul Employee Process", "Add Indivisul Employee Process Record", "", "SUL");
}
?>
                ...
                <div class="card-block">
                    <div class="row">
                        <div class="col-xl-4">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="emp_process" class="form-control" placeholder="Type Country" id="l30" >
                                        </div>
                                    </div>
                                </div>
                            ...
                            @else
                            <form name="IndivisulemployeeProcess" action="{{url('Settings/IndivisulemployeeProcess/Add')}}" method="post">
                                {{csrf_field()}}
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <label for="l30">Employee Code</label>
                                            <input type="text" name="emp_process" class="form-control" placeholder="Type Employee Code" id="l30" >
                                        </div>
                                    </div>
                                </div>
