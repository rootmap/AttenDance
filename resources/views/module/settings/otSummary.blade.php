<?php
$pageinfo = array("Over Time Report Summary", "Over Time Report Summary", "", "SUL", "Filter Over Time Report Summary", "Genarate Report");
?>
...
//                                }
                                ...
                                $(document).ready(function () {
                                    ...
                                    $("button[name='filter']").click(function () {
                                        ...
                                        $.post("<?= url('OTSummary/Report') ?>", {'company': company, 'department': department_id, 'start_date': s_date, 'end_date': e_date, '_token': '<?= csrf_token() ?>'}, function (data) {
...
//                                               
                                    ...
                                    $("#export_excel").click(function () {
                                        var company = 0;
                                        var inpc = $("input[name='company_id']").length;
                                        if (inpc == 0)
                                        {
                                            var company = $("select[name='company_id']").val();
                                            if (company == '' || $("select[name='company_id']").length == 0) {
                                        ...
                                        {
                                            var company = $("input[name='company_id']").val();
                                        }
                                        ...
                                        var link = "<?= url('OTSummary/Export/Excel') ?>/" + company + "/" + department + "/" + start_date + "/" + end_date;
                                    ...
                                    $("#export_pdf").click(function () {
                                        ...
                                        var start_date = $("input[name='start_date']").val();
                                        var end_date = $("input[name='end_date']").val();
                                        var link = "<?= url('/') ?>/OTSummary/Export/Pdf/" + company + "/" + department + "/" + start_date + "/" + end_date;
                                        window.location.href = link;
