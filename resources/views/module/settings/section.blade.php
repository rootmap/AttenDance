<?php
if (isset($data)) {
    $pageinfo = array("Edit Section Settings", "Edit Section Record", "", "SUL");
} else {
    $pageinfo = array("Section Settings", "Add Section Record", "", "SUL");
}
?>
                ...
                <div class="card-block">
                    <div class="row">
                        <div class="col-xl-12">
                            ...
                            @if(isset($data))
                            <form name="Section" action="{{url('Settings/Section/Update/'.$data['id'])}}" method="post">
                                {{csrf_field()}}
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label for="l30">Section Name</label>
                                            <input type="text" name="name" class="form-control" placeholder="Type Section" id="l30" value="{{$data['name']}}">
                                        </div>
                                    </div>
                            ...
                            @else
                            <form name="Section" action="{{url('Settings/Section/Add')}}" method="post">
                                {{csrf_field()}}
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label for="l30">Section Name</label>
                                            <input value="{{ old('name') }}" type="text" name="name" class="form-control" placeholder="Type Section" id="l30">
                                        </div>
                                    </div>
                                    @if(empty($logged_emp_com))
                                    <div class="col-lg-6">
...
<!--                                                @if(isset($department))
                        ...
                        <div class="col-xl-12">
                            ...
                            <script id="action_template" type="text/x-kendo-template">
                                <a class="k-button k-button-icontext k-grid-edit" href="{{url('Settings/Section/Edit')}}/#=id#"><span class="k-icon k-edit"></span> Edit</a>
                                ...
                                $(document).ready(function () {
                                    ...
                                    $("#grid").kendoGrid({
                                        ...
                                        columns: [
                                            ...
                                            {field: "name", title: "Section Name ", width: "80px"},
