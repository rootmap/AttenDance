<?php
$pageinfo = array("User Job Card Report", "User Job Card Report", "", "SUL", "Filter User Jobcard", "Genarate Report");
?>
...
//                                                            $.each(key.data, function (datagr, keyg) {
...
//                                                            $("#a1").html(page_countitem + " Quantity in " + page_item + " Item ");
//                                                            $("#a2").html(parseFloat(page_total_our_cost).toFixed(2));
//                                                            $("#a3").html(parseFloat(page_total_retail_cost).toFixed(2));
//                                                            $("#a4").html(parseFloat((page_total_retail_cost - page_total_our_cost)).toFixed(2));
                                                        }
                                                    })
                                                }
...
//                                                template: multiSelectArrayToString// function that generates the multiSelect control
                                ...
                                $(document).ready(function () {
                                    ...
                                    $("#export_excel").click(function () {
                                        ...
                                        var link = "<?= url('/') ?>/Jobcard/Export/UserExcel/" + emp_code + "/" + start_date + "/" + end_date;
                                    ...
                                    $("#export_pdf").click(function () {
                                        ...
                                        var param = {'emp_code': emp_code, 'start_date': start_date, 'end_date': end_date, '_token': '<?= csrf_token() ?>'};
                                        var link = "<?= url('/') ?>/Jobcard/Export/UserPdf/" + emp_code + "/" + start_date + "/" + end_date;
                                        window.location.href = link;
