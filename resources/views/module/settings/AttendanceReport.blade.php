<?php
$pageinfo = array("Attendance Report", "Attendance Report", "", "SUL", "Filter Attendance Report", "Genarate Report");
?>
                                ...
                                $(document).ready(function () {
                                    ...
                                    $("button[name='filter']").click(function () {
                                        ...
                                        var param = {'emp_code': employee_code,
                                            ...
                                            'end_date': e_date,
                                            '_token': '<?= csrf_token() ?>'};
                                        var link = "AttendanceReport/Report";
                                    ...
                                    $("#export_excel").click(function () {
                                        ...
                                        var link = "<?= url('/') ?>/AttendanceReport/Export/Excel/" + emp_code + "/" + start_date + "/" + end_date;
                                    ...
                                    $("#export_pdf").click(function () {
                                        ...
                                        var param = {'emp_code': emp_code, 'start_date': start_date, 'end_date': end_date, '_token': '<?= csrf_token() ?>'};
                                        var link = "<?= url('/') ?>/AttendanceReport/Export/Pdf/" + emp_code + "/" + start_date + "/" + end_date;
                                        window.location.href = link;
