<?php
$pageinfo = array("Standard OT Summary", "Standard OT Summary", "", "SUL", "Filter Standard OT Summary", "Genarate Report");
?>
...
//                                }
                                ...
                                $(document).ready(function () {
                                    ...
                                    $("button[name='filter']").click(function () {
                                        ...
                                        $.post("<?= url('StandardOTSummary/Report') ?>", {'company': company, 'department': department_id, 'start_date': s_date, 'end_date': e_date, '_token': '<?= csrf_token() ?>'}, function (data) {
...
//                                               
                                    ...
                                    $("#export_excel").click(function () {
                                        ...
                                        var link = "<?= url('StandardOTSummary/Export/Excel') ?>/" + company + "/" + department + "/" + start_date + "/" + end_date;
                                    ...
                                    $("#export_pdf").click(function () {
                                        ...
                                        var start_date = $("input[name='start_date']").val();
                                        var end_date = $("input[name='end_date']").val();
                                        var link = "<?= url('/') ?>/StandardOTSummary/Export/Pdf/" + company + "/" + department + "/" + start_date + "/" + end_date;
                                        window.location.href = link;
