...
if(isset($data))
{
    $pageinfo=array("Edit Department Settings","Edit Department Record","","SUL");
}
else
{
    $pageinfo=array("Department Settings","Add Department Record","","SUL");
}
				...
				<div class="card-block">
					<div class="row">
						<div class="col-xl-4">
                            ...
                            @if(isset($data))
                            <form name="Department" action="{{url('Settings/Department/Update/'.$data['id'])}}" method="post">
                                {{csrf_field()}}
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <label for="l30">Department Name</label>
                                            <input type="text" name="name" class="form-control" placeholder="Type Department" id="l30" value="{{$data['name']}}">
                                        </div>
                                    </div>
                            ...
                            @else
							<form name="Department" action="{{url('Settings/Department/Add')}}" method="post">
                                {{csrf_field()}}
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <label for="l30">Department Name</label>
                                            <input value="{{ old('name') }}" type="text" name="name" class="form-control" placeholder="Type Department" id="l30">
                                        </div>
                                    </div>
                        ...
                        <div class="col-xl-8">
                            ...
                            <script id="action_template" type="text/x-kendo-template">
                                <a class="k-button k-button-icontext k-grid-edit" href="{{url('Settings/Department/Edit')}}/#=id#"><span class="k-icon k-edit"></span> Edit</a>
                            ...
                            <script type="text/javascript">
                                $(document).ready(function () {
                                    var dataSource = new kendo.data.DataSource({
                                        transport: {
                                            read: {
                                                url: "<?=url('Settings/Department/Json')?>",
                                                type: "GET",
                                                datatype: "json"
