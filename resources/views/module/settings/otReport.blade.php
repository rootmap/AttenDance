<?php
$pageinfo = array("Over Time Report", "Over Time Report", "", "SUL", "Filter Over Time Report", "Genarate Report");
?>
                            ...
                            <script type="text/javascript">
                                ...
                                $(document).ready(function () {
                                    ...
                                    $("#export_excel").click(function () {
                                        ...
                                        var link = "<?= url('/') ?>/OTReport/Export/Excel/" + emp_code + "/" + start_date + "/" + end_date;
                                    ...
                                    $("#export_pdf").click(function () {
                                        ...
                                        var param = {'emp_code': emp_code, 'start_date': start_date, 'end_date': end_date, '_token': '<?= csrf_token() ?>'};
                                        var link = "<?= url('/') ?>/OTReport/Export/Pdf/" + emp_code + "/" + start_date + "/" + end_date;
                                        window.location.href = link;
