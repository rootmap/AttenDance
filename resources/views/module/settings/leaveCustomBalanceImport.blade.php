<?php
    $pageinfo = array("Import Leave User Custom Balance File ", "Import Leave User Custom Balance File", "", "SUL");
?>
                ...
                <div class="card-block">
                    <div class="row">
                        <div class="col-xl-4">
                            ...
                            <form name="LeaveUserBalance" enctype="multipart/form-data"  action="{{url('/Settings/UserLeaveCustomBalance/Add')}}" method="post">
                                {{csrf_field()}}
                                <div class="row">
                                    <div class="col-lg-12">
