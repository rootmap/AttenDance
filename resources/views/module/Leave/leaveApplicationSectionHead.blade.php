<?php
if (isset($data)) {
    $pageinfo = array("Section Head - Edit Leave Application Info", "Section Head - Edit Leave Application Record", "", "SUL");
} else {
    $pageinfo = array("New Leave Application Info", "Section Head - Add Leave Application Record", "", "SUL");
}
?>
                ...
                <div class="card-block">
                    <div class="row">
                        <div class="col-xl-12">
                            ...
                            @else
                            <form name="LeaveApplication" id="LeaveApplication" action="{{url('/Leave/LeaveApplication/SectionHead/Add')}}" method="post" enctype="multipart/form-data">
                                {{csrf_field()}}
                                <div class="row">
                                    ...
                                    <script type="text/javascript">
                                        $(document).ready(function () {
                                            $("select[name='company_id']").change(function () {
                                                if ($(this).val() != '')
                                                {
                                                    $.post("<?= url('Settings/LeaveUserData/Get/Employees/Section/Json') ?>", {'company_id': $(this).val(), '_token': '<?= csrf_token() ?>'}, function (data) {
                                    ...
                                    <script type="text/javascript">
                                        $(document).ready(function () {
                                            ...
                                            $.post("<?= url('Settings/LeaveUserData/Get/Employees/Section/Json') ?>", {'company_id': company_id, '_token': '<?= csrf_token() ?>'}, function (data) {
                                                var total = data.length;
                                                if (total != 0)
                                                {
                                                    var str = '';
                        ...
                        <div class="col-xl-12">
                            ...
                            <section class="card" id="sum-his-div">
