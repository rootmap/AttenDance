<?php
if (isset($data)) {
    $pageinfo = array("HR - Edit Leave Application Info", "HR - Edit Leave Application Record", "", "SUL");
} else {
    $pageinfo = array("HR - Leave Application Info", "HR - Add Leave Application Record", "", "SUL");
}
?>
                ...
                <div class="card-block">
                    <div class="row">
                        <div class="col-xl-12">
                            ...
                            @else
                            <form name="LeaveApplication" id="LeaveApplication" action="{{url('/Leave/LeaveApplication/HR/Add')}}" method="post" enctype="multipart/form-data">
                                {{csrf_field()}}
                                <div class="row">
